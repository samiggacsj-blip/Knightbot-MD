/**
 * .⤹بــــــــــط الاسطوࢪي'ي               𓅆⤾. - A WhatsApp Bot
        ...
        if (connection == "open") {
            ...
            try {
                ...
                await XeonBotInc.sendMessage(botNumber, {
                    ...
                    https://whatsapp.com/channel/0029Vb8QyE2KgsNvTVmCvM2L`,
                    contextInfo: {
                        forwardingScore: 1,
                        isForwarded: true,                        
                    }
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || '.⤹بــــــــــط الاسطوࢪي'ي               𓅆⤾.'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: المطور .⤹بــــــــــط الاسطوࢪي'ي               𓅆⤾.`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: mrunqiuehacker`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: The developer .⤹بــــــــــط الاسطوࢪي'ي               𓅆⤾.`))
